<template>
  <header
    class="fixed top-0 z-10 w-full bg-white shadow-sm h-50px sm:px-0 px-2"
  >
    <div
      class="flex items-center justify-between h-full mx-auto max-w-1170 container"
    >
      <div class="flex items-center">
        ...
        <div class="ml-4 flex">
          ...
          <input
            type="search"
            class="bg-gray-100 rounded ml-1 w-6/12 sm:w-full"
            placeholder="搜尋"
          />
        </div>
      </div>
      <!-- 手機版 -->
      <div class="ml-4 justify-center items-center flex sm:hidden">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 20 20"
          fill="currentColor"
          :class="[isCart, 'cursor-pointer', 'w-11']"
          @click="openCart"
        >
          <path
      ...
      <div class="justify-end items-center hidden sm:flex">
        <div>
